python3 -u gentx.py 0.1 | go run ./cmd/mp1_node node1 ./config/config_3local.txt 2> order_log/order1.txt
python3 -u gentx.py 0.1 | go run ./cmd/mp1_node node2 ./config/config_3local.txt 2> order_log/order2.txt
python4 -u gentx.py 0.1 | go run ./cmd/mp1_node node3 ./config/config_3local.txt 2> order_log/order3.txt
